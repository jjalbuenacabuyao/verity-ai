...
/**
 * Renders a toast notification when the file upload limit is exceeded.
    ...
    <>
      ...
      >
        <Description className="max-w-md text-sm">
          You can only upload a maximum of <span className="font-semibold">20</span> files each time.
        </Description>
        <Close>
